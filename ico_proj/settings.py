"""
Django settings for ico_proj project.
...
#SECRET_KEY = '54je*e^69#*rxyg3lhu_!vt@$an+z*-c*sp4gqm^+i6ure=+1^'
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', '54je*e^69#*rxyg3lhu_!vt@$an+z*-c*sp4gqm^+i6ure=+1^')
...
WSGI_APPLICATION = 'ico_proj.wsgi.application'
